...
class Slider {
    ...
    #slider_container;          //container for slider's instance
    #slide_index;               //number of the starting slide
    #slides;                    //slides items list
    #prev_button;               //previous slide button
    #next_button;               //next slide button
    #dots_container;            //container for dots as control items
    #dot;                       //single dot item
    #dots;                      //dots items list
    ...
    constructor(slider_container, start_slide_index, slide_item, prev_button, next_button, dots_container = undefined, dot = undefined) {
        ...
        this.#slide_index = start_slide_index;
        this.#slides = this.#slider_container.querySelectorAll(slide_item);
        this.#prev_button = this.#slider_container.querySelector(prev_button);
        this.#next_button = this.#slider_container.querySelector(next_button);

        //check the availability of the dots and its container into the object instance
        if ((dots_container && dot) !== undefined) {
            this.#dots_container = document.querySelector(dots_container);
            ...
            this.#show_slide();                                                  //initialize new slider object
        }
    }
